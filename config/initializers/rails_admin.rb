# RailsAdmin config file. Generated on December 15, 2013 18:40
...
RailsAdmin.config do |config|
  ...
  # config.excluded_models = ['Category', 'Role', 'User', 'Website', 'WebsiteCategoryship']

  # Include specific models (exclude the others):
  # config.included_models = ['Category', 'Role', 'User', 'Website', 'WebsiteCategoryship']
  ...
  #     configure :website_categoryships, :has_many_association 
  ...
  # config.model 'WebsiteCategoryship' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your website_categoryship.rb model definition
